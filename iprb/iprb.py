...
population containing k+m+n organisms: k individuals are homozygous dominant
for a factor, m are heterozygous, and n are homozygous recessive" and returns
    ...
    for parent1 in GENOTYPES:
        ...
        for parent2 in GENOTYPES:
            ...
            if parent1 == HOM_DOM or parent2 == HOM_DOM:
                # If either parent is homozygous dominant then all offspring
                # are phenotypically dominant
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='Three positive integers k, m, and n, representing a population '
